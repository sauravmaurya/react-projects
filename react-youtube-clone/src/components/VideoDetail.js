                    ...
                    <Box sx={{ width: "100%", position: "sticky", top: "86px" }}>
                        ...
                        <Stack direction="row" justifyContent="space-between" sx={{ color: "#fff" }} px={2} py={1}>
                            ...
                            <Stack direction="row" alignItems="center" gap="20px">
                                <Typography variant="body1" sx={{ opavity: "0.7" }}>{parseInt(viewCount).toLocaleString()} views</Typography>
                                <Typography variant="body1" sx={{ opavity: "0.7" }}>{parseInt(likeCount).toLocaleString()} likes</Typography>
                            </Stack>
                        </Stack>
                    </Box>
                </Box>
